...
Personal Data processed: city, company name, country, date of birth, email address, first name, last name, phone number, physical address, profession, Trackers, Usage Data and various types of Data as specified in the privacy policy of the service.
