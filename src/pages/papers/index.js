...
export default function Papers() {
  ...
  return (
    <Layout title="Papers">
      ...
      <div className="abt-b-txt"><h1>Papers</h1>
                ...
                <div className="desc-area">
                   <div className="paper-title">
                    ...
                    <div className="dwn-btn">
                        {/* <button className="btn-more"  onClick={handleRedirect}>Download</button> */}
     ...
     {isModalOpen && (
        <div className="modal-overlay"  onClick={handleOverlayClick}>
          <div className="modal-box pForm">
            <span className="modal-close" onClick={closeModal} title="close">&times;</span>
