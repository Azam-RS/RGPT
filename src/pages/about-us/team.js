...
export default function Team() {
    ...
    const boardMember3 = [
        {
            id: 13, name: "Dr. Naveed Sherwani", role: "Chairman", image: "/img/naveed.png",
    ...
    const boardMembers = [...boardMember1, ...boardMember2, ...boardMember3, ...TeamMember1];
